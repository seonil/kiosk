...
export const ArrowRightIcon: React.FC<{ className?: string }> = ({ className = "" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="37" height="11" viewBox="0 0 37 11" fill="none" className={className}>
    <path d="M0 10.3672H35L24.1818 0.367188" stroke="#09294A" />
  </svg>
);
